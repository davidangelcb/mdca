...
?>
	...
	<footer itemscope itemtype="http://schema.org/WPFooter" id="footer" role="contentinfo" class = "footer grey-bg">
		...
		<div class="container">
			...
			<?php echo apply_filters( 'llorix_one_plus_footer_text_filter', '<div class="powered-by"><a href="http://themeisle.com/themes/llorix-one/" rel="nofollow">Unidad de Sistemas e Informática </a>' . esc_html__( '- Municipalidad de Cerro Azul -', 'llorix-one-lite' ) . ' <a href="http://wordpress.org/" rel="nofollow">' . esc_html__( 'MCDA', 'llorix-one-lite' ) . '</a></div>' ); ?>
